      ...
      <div className="mb-5">
        ...
        <div className="flex justify-center flex-wrap gap-9">
          <div className="flex-1 sm:w-[350px] sm:min-w-[350px] w-full rounded-[20px] shadow-3xl px-10 py-10">
            <h3 className="mt-1 font-palanquin text-3xl leading-normal font-bold">
          ...
          <div className="flex-1 sm:w-[350px] sm:min-w-[350px] w-full rounded-[20px] shadow-3xl px-10 py-10">
            ...
            <p className="mt-3 break-words font-montserrat text-lg leading-normal text-slate-gray">
              Offrir une éducation équilibrée alliant apprentissage académique,
              activités physiques et enrichissement culturel, afin de soutenir
              le développement intellectuel, physique et émotionnel des élèves.
            </p>
          </div>
          <div className="flex-1 sm:w-[350px] sm:min-w-[350px] w-full rounded-[20px] shadow-3xl px-10 py-10">
            <h3 className="mt-1 font-palanquin text-3xl leading-normal font-bold">
            ...
            <p className="mt-3 break-words font-montserrat text-lg leading-normal text-slate-gray">
              Adopter des pratiques durables pour garantir la gestion
              responsable de Lemuria, assurant sa viabilité environnementale et
          ...
          <div className="flex-1 sm:w-[350px] sm:min-w-[350px] w-full rounded-[20px] shadow-3xl px-10 py-10">
            ...
            <p className="mt-3 break-words font-montserrat text-lg leading-normal text-slate-gray">
              Établir des partenariats avec des organisations locales et
              internationales pour soutenir les programmes de Lemuria et
              favoriser des relations de collaboration avec la communauté
              locale.
            </p>
          </div>
        </div>
